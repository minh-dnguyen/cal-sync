...
const en = {
  ...
  connected_accounts_section: "Connected Accounts",
  connect_google:             "Connect Google Calendar",
  connecting_google:          "Connecting…",
  google_connected_as:        "Connected as {{email}}",
  google_connected:           "Google Calendar connected",
  disconnect:                 "Disconnect",
  disconnecting:              "Disconnecting…",
  sync_now:                   "Sync now",
  syncing_google:             "Syncing…",
  google_sync_error:          "Sync failed. Try again.",
...
const fr: TranslationKeys = {
  ...
  occurrences:           "occurrence(s)",
  connected_accounts_section: "Comptes connectés",
  connect_google:             "Connecter Google Agenda",
  connecting_google:          "Connexion…",
  google_connected_as:        "Connecté en tant que {{email}}",
  google_connected:           "Google Agenda connecté",
  disconnect:                 "Déconnecter",
  disconnecting:              "Déconnexion…",
  sync_now:                   "Synchroniser",
  syncing_google:             "Synchronisation…",
  google_sync_error:          "Échec de la synchronisation. Réessayez.",
...
const es: TranslationKeys = {
  ...
  connected_accounts_section: "Cuentas conectadas",
  connect_google:             "Conectar Google Calendar",
  connecting_google:          "Conectando…",
  google_connected_as:        "Conectado como {{email}}",
  google_connected:           "Google Calendar conectado",
  disconnect:                 "Desconectar",
  disconnecting:              "Desconectando…",
  sync_now:                   "Sincronizar ahora",
  syncing_google:             "Sincronizando…",
  google_sync_error:          "Error al sincronizar. Inténtalo de nuevo.",
...
const de: TranslationKeys = {
  ...
  connected_accounts_section: "Verbundene Konten",
  connect_google:             "Google Kalender verbinden",
  connecting_google:          "Verbinden…",
  google_connected_as:        "Verbunden als {{email}}",
  google_connected:           "Google Kalender verbunden",
  disconnect:                 "Trennen",
  disconnecting:              "Trennen…",
  sync_now:                   "Jetzt synchronisieren",
  syncing_google:             "Synchronisierung…",
  google_sync_error:          "Synchronisierung fehlgeschlagen. Erneut versuchen.",
...
const pt: TranslationKeys = {
  ...
  connected_accounts_section: "Contas conectadas",
  connect_google:             "Conectar Google Agenda",
  connecting_google:          "Conectando…",
  google_connected_as:        "Conectado como {{email}}",
  google_connected:           "Google Agenda conectado",
  disconnect:                 "Desconectar",
  disconnecting:              "Desconectando…",
  sync_now:                   "Sincronizar agora",
  syncing_google:             "Sincronizando…",
  google_sync_error:          "Falha na sincronização. Tente novamente.",
...
const it: TranslationKeys = {
  ...
  connected_accounts_section: "Account collegati",
  connect_google:             "Collega Google Calendar",
  connecting_google:          "Collegamento…",
  google_connected_as:        "Collegato come {{email}}",
  google_connected:           "Google Calendar collegato",
  disconnect:                 "Disconnetti",
  disconnecting:              "Disconnessione…",
  sync_now:                   "Sincronizza ora",
  syncing_google:             "Sincronizzazione…",
  google_sync_error:          "Sincronizzazione non riuscita. Riprova.",
...
const ru: TranslationKeys = {
  ...
  connected_accounts_section: "Подключённые аккаунты",
  connect_google:             "Подключить Google Календарь",
  connecting_google:          "Подключение…",
  google_connected_as:        "Подключено как {{email}}",
  google_connected:           "Google Календарь подключён",
  disconnect:                 "Отключить",
  disconnecting:              "Отключение…",
  sync_now:                   "Синхронизировать",
  syncing_google:             "Синхронизация…",
  google_sync_error:          "Ошибка синхронизации. Повторите попытку.",
...
const zh: TranslationKeys = {
  ...
  occurrences:           "次",
  connected_accounts_section: "已连接账户",
  connect_google:             "连接 Google 日历",
  connecting_google:          "连接中…",
  google_connected_as:        "已连接：{{email}}",
  google_connected:           "Google 日历已连接",
  disconnect:                 "断开连接",
  disconnecting:              "断开中…",
  sync_now:                   "立即同步",
  syncing_google:             "同步中…",
  google_sync_error:          "同步失败，请重试。",
...
const ja: TranslationKeys = {
  ...
  occurrences:           "回",
  connected_accounts_section: "接続済みアカウント",
  connect_google:             "Google カレンダーを接続",
  connecting_google:          "接続中…",
  google_connected_as:        "{{email}} として接続済み",
  google_connected:           "Google カレンダーを接続しました",
  disconnect:                 "切断",
  disconnecting:              "切断中…",
  sync_now:                   "今すぐ同期",
  syncing_google:             "同期中…",
  google_sync_error:          "同期に失敗しました。再試行してください。",
...
const ar: TranslationKeys = {
  ...
  connected_accounts_section: "الحسابات المرتبطة",
  connect_google:             "ربط تقويم Google",
  connecting_google:          "جارٍ الربط…",
  google_connected_as:        "مرتبط بـ {{email}}",
  google_connected:           "تم ربط تقويم Google",
  disconnect:                 "فصل",
  disconnecting:              "جارٍ الفصل…",
  sync_now:                   "مزامنة الآن",
  syncing_google:             "جارٍ المزامنة…",
  google_sync_error:          "فشلت المزامنة. حاول مجدداً.",
...
const ko: TranslationKeys = {
  ...
  occurrences:           "회",
  connected_accounts_section: "연결된 계정",
  connect_google:             "Google 캘린더 연결",
  connecting_google:          "연결 중…",
  google_connected_as:        "{{email}}(으)로 연결됨",
  google_connected:           "Google 캘린더가 연결되었습니다",
  disconnect:                 "연결 해제",
  disconnecting:              "해제 중…",
  sync_now:                   "지금 동기화",
  syncing_google:             "동기화 중…",
  google_sync_error:          "동기화 실패. 다시 시도하세요.",
...
const vi: TranslationKeys = {
  ...
  occurrences:           "lần",
  connected_accounts_section: "Tài khoản đã kết nối",
  connect_google:             "Kết nối Google Calendar",
  connecting_google:          "Đang kết nối…",
  google_connected_as:        "Đã kết nối với {{email}}",
  google_connected:           "Đã kết nối Google Calendar",
  disconnect:                 "Ngắt kết nối",
  disconnecting:              "Đang ngắt kết nối…",
  sync_now:                   "Đồng bộ ngay",
  syncing_google:             "Đang đồng bộ…",
  google_sync_error:          "Đồng bộ thất bại. Thử lại.",
...
const tr: TranslationKeys = {
  ...
  occurrences:           "tekrar",
  connected_accounts_section: "Bağlı Hesaplar",
  connect_google:             "Google Takvim'i Bağla",
  connecting_google:          "Bağlanıyor…",
  google_connected_as:        "{{email}} olarak bağlandı",
  google_connected:           "Google Takvim bağlandı",
  disconnect:                 "Bağlantıyı Kes",
  disconnecting:              "Bağlantı kesiliyor…",
  sync_now:                   "Şimdi Senkronize Et",
  syncing_google:             "Senkronize ediliyor…",
  google_sync_error:          "Senkronizasyon başarısız. Tekrar deneyin.",
...
const pl: TranslationKeys = {
  ...
  connected_accounts_section: "Połączone konta",
  connect_google:             "Połącz Kalendarz Google",
  connecting_google:          "Łączenie…",
  google_connected_as:        "Połączono jako {{email}}",
  google_connected:           "Kalendarz Google połączony",
  disconnect:                 "Rozłącz",
  disconnecting:              "Rozłączanie…",
  sync_now:                   "Synchronizuj teraz",
  syncing_google:             "Synchronizacja…",
  google_sync_error:          "Synchronizacja nie powiodła się. Spróbuj ponownie.",
...
const hi: TranslationKeys = {
  ...
  occurrences:           "बार",
  connected_accounts_section: "कनेक्टेड अकाउंट",
  connect_google:             "Google Calendar से जोड़ें",
  connecting_google:          "कनेक्ट हो रहा है…",
  google_connected_as:        "{{email}} के रूप में जुड़ा हुआ",
  google_connected:           "Google Calendar जुड़ गया",
  disconnect:                 "डिस्कनेक्ट करें",
  disconnecting:              "डिस्कनेक्ट हो रहा है…",
  sync_now:                   "अभी सिंक करें",
  syncing_google:             "सिंक हो रहा है…",
  google_sync_error:          "सिंक विफल। पुनः प्रयास करें।",
...
const nl: TranslationKeys = {
  ...
  connected_accounts_section: "Gekoppelde accounts",
  connect_google:             "Google Agenda koppelen",
  connecting_google:          "Koppelen…",
  google_connected_as:        "Verbonden als {{email}}",
  google_connected:           "Google Agenda gekoppeld",
  disconnect:                 "Ontkoppelen",
  disconnecting:              "Ontkoppelen…",
  sync_now:                   "Nu synchroniseren",
  syncing_google:             "Synchroniseren…",
  google_sync_error:          "Synchronisatie mislukt. Probeer opnieuw.",
